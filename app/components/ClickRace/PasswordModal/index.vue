                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-3 pt-4">
                        ...
                        <button
                            ...
                            class="flex-1 rounded-xl bg-blue-600 px-4 py-3 text-white font-medium transition-colors hover:bg-blue-700 disabled:bg-neutral-700 disabled:text-neutral-400 disabled:cursor-not-allowed"
                        >
